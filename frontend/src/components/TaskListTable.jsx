      ...
      <table className='min-w-full'>
        <thead>
          <tr className='text-left'>
            <th className='py-3 px-4 text-gray-800 text-[13px] font-medium'>Name</th>
            <th className='py-3 px-4 text-gray-800 text-[13px] font-medium'>Status</th>
            <th className='py-3 px-4 text-gray-800 text-[13px] font-medium'>Priority</th>
            <th className='py-3 px-4 text-gray-800 text-[13px] font-medium hidden md:table-cell'>Created On</th>
          </tr>
        </thead>
        <tbody>
          {tableData.map((task) => (
