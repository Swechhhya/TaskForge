...
const TaskListTable = ({tableData}) => {
    ...
    const getPriorityBadgeColor = (priority) => {
        switch(priority) {
            case 'High': return 'bg-red-100 text-red-500 border border-re-200';
        ...
        <table className='min-w-full'>
            <thead>
                <tr className='text-left'>
                    <th className='py-3 px-4 text-gray-800 font-medium-[13px]'>Name</th>
                    <th className='py-3 px-4 text-gray-800 font-medium-[13px]'>Status</th>
                    <th className='py-3 px-4 text-gray-800 font-medium-[13px]'>Priority</th>
                    <th className='py-3 px-4 text-gray-800 font-medium-[13px] hidden md:table-cell'>Created On</th>
                  </tr>
